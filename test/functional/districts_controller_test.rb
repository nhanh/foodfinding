...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { districtName: @district.districtName, districtSynomyms: @district.districtSynomyms }
    end
  ...
  test "should update district" do
    put :update, id: @district, district: { districtName: @district.districtName, districtSynomyms: @district.districtSynomyms }
    assert_redirected_to district_path(assigns(:district))
  end
